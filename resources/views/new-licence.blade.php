<x-landing>
    <x-slot name="title">Buy a new licence</x-slot>
    ...
    <section class="w-full py-12 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <script src="https://www.paypal.com/sdk/js?client-id={{ env('PAYPAL_SANDBOX_CLIENT_ID') }}"></script>
                ...
                <div class="lg:grid lg:grid-cols-2 lg:gap-36">
                    <div class="col-start-2" id="payment form">
                        @csrf
                        <h2 class="text-lg text-gray-600 mb-2">Your personal informations</h2>
                        ...
                        <h2 class="text-lg text-gray-600 mb-2">Your billing data</h2>
