        ...
        <section class="w-full py-12 bg-white">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex flex-col lg:items-center justify-center w-full">
                    <h1 class="font-semibold text-purple-900 dark:text-white text-3xl md:text-4xl">The right plan for your business</h1>
                        ...
                        <div class="container mx-auto">
                            ...
                            <div class="lg:grid lg:grid-cols-3 lg:gap-8">
                                <div class="py-5 px-4 bg-white dark:bg-gray-800 border dark:border-gray-700 border-gray-200 shadow rounded-lg text-left mb-8 lg:mb-0 flex flex-col">
                                    <h2 class="text-2xl text-purple-900 font-semibold mb-8">Free trial</h2>
                                        ...
                                        <p class="text-base text-purple-900 relative pl-3">
                                            <span class="font-light text-lg">$</span>
                                            <span class="text-2xl font-semibold">0</span>
                                            <span class="font-light text-lg">/month</span>
                                        </p>
{{--                                         <a href="{{ route('landing.try') }}" class="mt-4 flex items-center justify-center rounded-lg border border-transparent bg-purple-900 hover:opacity-90 text-white p-2 text-base font-bold">Get a free trial</a>
 --}}                                </div>
                                <div class="py-5 px-4 bg-purple-900 border dark:border-gray-700 border-gray-200 shadow rounded-lg text-left mb-8 lg:mb-0 flex flex-col">
...
{{--                                         <form method="POST" action="{{ route('landing.buy-licence') }}">
 --}}                                            @csrf
                                            ...
                                            <button type="submit" class="mt-4 flex items-center justify-center rounded-lg border border-transparent bg-gray-100 hover:bg-white text-purple-900 p-2 text-base font-bold w-full">Pay now</button>
                                            <span class="text-red-500">{{ $errors->first('plan') }}</span>
                                        </form>
                                </div>
                                <div class="py-5 px-4 bg-white dark:bg-gray-800 border dark:border-gray-700 border-gray-200 shadow rounded-lg text-left mb-8 lg:mb-0 flex flex-col">
                                    <h2 class="text-2xl text-purple-900 font-semibold mb-8">Full</h2>
                                        <ul class="flex-1 flex flex-col mb-6">
                                            <li class="flex items-center mb-2.5">
                                                <img src="https://cdn.tuk.dev/assets/templates/weCare/checkMark.png" class="mr-4 dark:hidden" alt="check-mark" />
                                                <img src="https://cdn.tuk.dev/assets/templates/weCare/checkMarkWhite.png" class="mr-4 hidden dark:block" alt="check-mark" />
...
{{--                                         <form method="POST" action="{{ route('landing.buy-licence') }}">
 --}}                                            @csrf
                                            ...
                                            <button type="submit" class="mt-4 flex items-center justify-center rounded-lg border border-transparent bg-purple-900 hover:opacity-90 text-white p-2 text-base font-bold w-full">Pay now</button>
                                            <span class="text-red-500">{{ $errors->first('plan') }}</span>
                                        </form>
                                </div>
                            </div>
