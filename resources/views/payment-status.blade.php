        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="w-full py-12 lg:px-28 px-8">
                @if (Session::has('end_error'))
                    <div class="bg-sky-800 p-8 text-white text-center">
                        {{ Session::get('end_error') }}
                        <br/>
                        If you have any questions, feel free to <a class="cursor-pointer underline" href="{{ route('contact') }}">get in touch</a> with us!
                    </div>
