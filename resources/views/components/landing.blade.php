...
<body>
    ...
    <!-- Navbar -->
    <div class="bg-sky-800 w-full sticky top-0" style="z-index: 99999;" x-data="{ showBar: false }" :class="{ 'shadow-xl transition duration-500' : showBar }"
    @scroll.window="showBar = (window.pageYOffset > 20) ? true : false">
        ...
        >
            ...
            <a class="text-white no-underline hover:text-white hover:no-underline py-4 lg:py-0 inline-block" href="{{ route('home') }}">
             <img src="{{ asset('/img/Hol_logobianco.png') }}" alt="HealtOnline Logo" width="125px" height="auto">
                {{-- <h2 class="text-3xl">HEALTH ONLINE</h2> --}}
            ...
            <div class="hidden lg:block"
                ...
                <ul class="pt-6 lg:pt-0 list-reset lg:flex justify-end flex-1 items-center">
                    ...
                    <li class="mr-3">
                        <a class="inline-block no-underline py-2 px-4 font-bold {{ request()->routeIs('landing.features') ? 'text-white' : 'text-gray-200 hover:text-white' }}" href="{{ route('about') }}" @click="isOpen = false">About</a>
                    </li>
                    <li class="mr-3">
            ...
            <div class="container mx-auto py-12">
                <div class="xl:flex lg:flex md:flex pt-6">
                    <div class="w-11/12 xl:w-3/6 lg:w-2/5 mx-auto lg:mx-0 xl:mx-0">
                        <div class="flex items-center mb-6 xl:mb-0 lg:mb-0">
                           ...
                           {{-- <h2 class="text-3xl text-sky-800">HEALTH ONLINE</h2> --}}
                           <img src="{{ asset('/img/HOL_logotrasparente.png') }}" alt="HealtOnline Logo" width="125px" height="auto">
                           </div>
                        </div>
                    </div>
                ...
                <div class="xl:flex flex-wrap justify-between xl:mt-24 mt-16 pb-6 pl-3 sm:pl-0">
                    <div class="w-11/12 xl:w-3/6 mx-auto lg:mx-0 xl:mx-0 mb-6 xl:mb-0">
                        <p tabindex="0" class="focus:outline-none text-gray-800 dark:text-white text-base">2022 Krill. All Rights Reserved | Powered by <a href="https://elaboranext.com" target="_blank" class="hover:text-sky-800 pointer underline">Elabora Next</a></p>
                    </div>
